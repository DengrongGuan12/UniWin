...
$(document).ready(() => {
    ...
    $("#repertory-out-quantity").prop("disabled", false);
...
console.log(data);
    if (data)
    {
        ...
        $("#repertory-out-location").val(data.storagePos);
        $("#material-inventoryAmount").val(data.inventoryAmount);
    }
}
...
function _saveAll(e) {
    ...
    const quantity = parseInt($("#repertory-out-quantity").val());
